 ...
 * This extension has no Save Hex of its own: it puts a hex somebody already has
 * onto a board, so the advice is about the file rather than about building one.
 */
const SAVE_HEX = 'Copy the hex file onto the MICROBIT drive instead.';
